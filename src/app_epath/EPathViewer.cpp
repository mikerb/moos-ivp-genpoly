...
void EPathViewer::handle_left_mouse(int vx, int vy, bool add_point)
{
...
void EPathViewer::handle_right_mouse(int vx, int vy)
{
  double ix = view2img('x', vx);
  double iy = view2img('y', vy);
  double mx = img2meters('x', ix);
...
string EPathViewer::getBorderSpec()
{  
...
string EPathViewer::getGPolySpec()
{  
...
void EPathViewer::reversePoints()
{
  m_segl.reverse();
  updateConvexHull();
  updateGenPoly();
...
void EPathViewer::reApplySnapToCurrent()
{
...
void EPathViewer::updateConvexHull()
{
  if(!m_draw_hull)
    return;
...
void EPathViewer::updateGenPoly()
{
  if(!m_draw_gpoly)
    return;
